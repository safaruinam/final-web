...
$dataDestinasi = "SELECT * FROM destinasi;";
$destinasi = mysqli_query($conn, $dataDestinasi);
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    ...
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="form_destinasi.php">Form Destinasi</a></li>
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Data Tabel Destinasi</h5>
                                        </div>
                                        <div class="card-block table-border-style">
                                            <a href="form_destinasi.php" type="button" class="btn btn-primary mb-3"> <i class="fa fa-plus"></i>Destinasi</a>
                                                ...
                                                <table class="table table-hover table-bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Destinasi</th>
                                                            <th>Gambar</th>
                                                            <th style="width: 150px; word-wrap: break-word;">Keterangan</th>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        while ($result = mysqli_fetch_assoc($destinasi)) {
                                                        ?>
                                                            <tr>
                                                                <td>
                                                                    <center>
                                                                        <?php echo ++$no_destinasi; ?>.
                                                                    </center>
                                                                </td>
                                                                <td>
                                                                    <?php echo $result['nama_lokasi']; ?>
                                                                </td>
                                                                <td>
                                                                    <img src="images/<?php echo $result['gambar_d']; ?>" alt="" style="width: 150px;">
                                                                </td>
                                                                <td style="width: 150px;">
                                                                    <p style="word-wrap: break-word;"><?php echo $result['detail']; ?></p>
                                                                </td>
                                                                <td style="width: 150px;">
                                                                ...
                                                                <td>
                                                                    <a href="form_destinasi.php?ubah=<?php echo $result['id_destinasi']; ?>" type="button" class="btn btn-warning btn-sm"><i class="feather icon-edit"></i>Ubah</a>
                                                                    <a href="crud_destinasi.php?hapus=<?php echo $result['id_destinasi']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Yakin ingin menghapus?')"> <i class="fa fa-trash"></i> Hapus</a>
                                                                </td>
                                                            </tr>
                                                        <?php
                                                        }
