...
<head>
   ...
   <title>Perlengkapan | HealingQu</title>
...
<body>
   ...
   <section class="perlengkapan">

      <h1 class="heading-title">Sewa Perlangkapan</h1>

      <div class="box-container">
         <?php $ambil = $conn->query("SELECT * FROM produk WHERE id_produk NOT IN (SELECT id_perlengkapan FROM sewa)"); ?>
         <?php
         if (isset($_POST['keyword'])) {
            $ambil = $conn->query("SELECT * FROM produk WHERE id_produk NOT IN (SELECT id_perlengkapan FROM sewa) AND nama_produk LIKE '%" . $_POST['keyword'] . "%'");
         } ?>
            ...
            <?php while ($ambildata = $ambil->fetch_assoc()) { ?>
               <div class="box">
                  ...
                  <div class="content">
                     ...
                     <div class="price">Rp <?php echo number_format($ambildata['harga_sewa']); ?><span>/hari</span> </div>
                     <div class="stars">
                     ...
                     if (isset($_SESSION['logged_in']) == true) {
                        echo '<a href="detail_produk.php?id=' . $ambildata['id_produk'] . '" class="btnBeli">Pesan</a>';
                     } else {
