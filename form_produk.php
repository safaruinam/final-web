                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Form Perlengkapan</h5>
                                    </div>
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                                        <li class="breadcrumb-item"><a href="tabel_produk.php">Tabel Perlengkapan</a></li>
                                        <li class="breadcrumb-item"><a href="#">Form Perlengkapan</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form method="POST" action="crud_produk.php" enctype="multipart/form-data">
                                                        <input type="hidden" value="<?php echo $id_produk; ?>" name="id_produk">
                                                        <div class="form-group">
                                                            <label for="nama_produk">Nama Produk</label>
                                                            <input type="text" class="form-control" id="nama_produk" name="nama_produk" placeholder="Masukkan Nama Perlengkapan" value="<?php echo $nama_produk; ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="g_produk">Gambar Produk</label>
                                                            <input <?php if (!isset($_GET['ubah'])) {
                                                                        echo "required";
                                                                    } ?> class="form-control" type="file" name="g_produk" id="g_produk" accept="image/*">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="harga_sewa">Harga</label>
                                                            <input required type="text" class="form-control" id="harga_sewa" name="harga_sewa" placeholder="Masukkan harga" value="<?php echo $harga_sewa; ?>">
                                                        </div>
                                                        <div class="float-right">
                                                            ...
                                                            ?>
                                                            <a href="tabel_produk.php" type="button" class="btn btn-danger">
